  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "はい。体系的に設計された4回のプログラムにより、基礎理解から実践活用まで着実にスキルアップできます。特に第3回の業務プロセス改善ワークでは、受講者様の実際の業務を題材にするため、研修終了と同時に現場での活用が開始できます。"
      },
      {
      ...
      },
      {
        ...
        answer: "はい、セキュリティ・コンプライアンス対応も重要な学習項目として組み込まれています。第1回の基礎理解では、安全なAI活用のためのガイドライン策定も含め、組織全体でのリスク管理体制構築をサポートします。"
      },
      {
        question: "研修後の組織展開や定着化支援はありますか？",
        answer: "第4回で組織展開方法を詳しく学習し、その後も継続的なサポートを提供します。社内でのAI活用推進体制構築、定期的なスキルアップ研修、ROI測定まで、持続可能なAI活用組織への変革を長期的にサポートいたします。"
      },
      {
