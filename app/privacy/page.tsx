      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none">
          <p className="text-gray-600 mb-6">
            LandBridge株式会社（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
          </p>
          ...
          <div className="bg-gray-50 p-6 rounded-lg text-gray-600">
            ...
            <p className="mb-2">住所：〒100-0001 東京都千代田区千代田1-1</p>
            <p className="mb-2">担当部署：個人情報管理責任者</p>
            <p className="mb-2">Eメールアドレス：privacy@landbridge.co.jp</p>
          </div>
