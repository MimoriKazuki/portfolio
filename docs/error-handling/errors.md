...
| `POST /api/bookmarks` | VALIDATION_ERROR、UNAUTHORIZED、NOT_FOUND、ALREADY_EXISTS |
| `DELETE /api/bookmarks/:id` | UNAUTHORIZED、NOT_FOUND |
| `/api/admin/**` | UNAUTHORIZED、FORBIDDEN、VALIDATION_ERROR、NOT_FOUND、CONFLICT、DUPLICATE_SLUG、IN_USE |
