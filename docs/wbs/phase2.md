...
| 2 | 認証基盤の整理 | 1 / 6 | 🔧 対応中（P2-AUTH-01 完了・02 以降未着手） |
...
| **Step 1 計** | | **9 / 9 ✅** | |
| P2-AUTH-01 | middleware 拡張（/e-learning 配下ガード） | ✅ 完了 | fc961af / 58c8a2b / 01a85bc / fc0323d / c083365 / 12460c4 / 23db10a / de77d44 / c0e23c0（Sub 2a・2a-2・2a-3 合計9コミット・78件テストパス・RLS 5テーブル本番適用済） |
| P2-AUTH-02 | OAuth コールバック整理（has_paid_access → has_full_access 統合） | 📋 未着手 | Sub 2b として着手予定 |
| P2-AUTH-03 | 退会機能（POST /api/me/withdraw + user-service.withdraw） | 📋 未着手 | Sub 2c |
| P2-AUTH-04 | 再登録時 deleted_at 解除（syncFromAuth） | 📋 未着手 | Sub 2c |
| P2-AUTH-05 | アプリコード切替（has_paid_access → has_full_access 置換） | 📋 未着手 | Sub 2e（10ファイル・約35箇所） |
| P2-AUTH-06 | has_paid_access カラム削除 | 📋 未着手 | Sub 2f（M5 段階移行 Step5） |
| **Step 2 計** | | **1 / 6 🔧** | |
| P2-ST-01 | Stripe Price ID 動的管理 | 📋 未着手 | |
| P2-ST-02 | charge.refunded Webhook 追加 | 📋 未着手 | |
| P2-ST-03 | Webhook 冪等性テスト | 📋 未着手 | |
| **Step 3 計** | | **0 / 3 📋** | |
| P2-DS-01 | カラートークン実装 | 📋 未着手 | |
| P2-DS-02 | タイポグラフィトークン実装 | 📋 未着手 | |
| P2-DS-03 | スペーシングトークン実装 | 📋 未着手 | |
| P2-DS-04 | レイアウトトークン実装 | 📋 未着手 | |
| **Step 4 計** | | **0 / 4 📋** | |
| P2-A-01〜04 | atoms 実装（18コンポーネント） | 📋 未着手 | |
| **Step 5 計** | | **0 / 4 📋** | |
...
| 2a-3 | A案 ADMIN_EMAIL 照合 + RLS 5テーブル削除（緊急対処） | ✅ 完了（c083365 / 12460c4 / 23db10a / de77d44 / c0e23c0） |
| 2b | user-service 新規 + OAuth callback リファクタ | 📋 未着手 |
| 2c | 退会機能 + 再活性化 | 📋 未着手 |
