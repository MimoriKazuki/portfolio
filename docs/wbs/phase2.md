...
## 進捗ステータス（最終更新：2026-05-13 Sub 2a-3 完全クローズ）
...
| 2 | 認証基盤の整理 | 1 / 6 | 🔧 対応中（P2-AUTH-01 完全完了・02 着手予定） |
...
| P2-AUTH-02 | OAuth コールバック整理（has_paid_access → has_full_access 統合） | 🔧 対応中 | Sub 2b として着手 |
...
| 2b | user-service 新規 + OAuth callback リファクタ + has_paid_access → has_full_access 統合 | 🔧 対応中 |
| 2c | 退会機能 + 再活性化 | 📋 未着手 |
